...
Step 2.  create amazon instance(refer to amazon notes) and in security group create "http" and "https" source "Anywhere"
...
Step 21. Nginx configuration
            commands: 
            **In aws_ec2_instance terminal
              $ sudo ln -nfs "/home/ubuntu/apps/your_app_name/current/config/nginx.conf" "/etc/nginx/sites-enabled/capistrano"
...
Note:- you can check your nginx logs by running the following command:
		    $ vim apps/your_app_name/current/log/production.log
